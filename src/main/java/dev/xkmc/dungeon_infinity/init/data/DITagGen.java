...
public class DITagGen {
	...
	public static final TagKey<Item> ALWAYS_KEEP = item("always_keep");
	...
	private static TagKey<Item> item(String id) {
		return ItemTags.create(DungeonInfinity.loc(id));
	}
	...
	public static void genItemTags(RegistrateItemTagsProvider pvd) {
		pvd.tag(ALWAYS_KEEP).addTag(MGTagGen.GOLEM_INTERACT);
	}
}
